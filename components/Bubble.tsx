...
const Bubble:JSXElementConstructor<any> = forwardRef(function Bubble({ content }, ref) {
  ...
  return (
    <div ref={ref  as RefObject<HTMLDivElement>} className={`block pb-[7px] clear-both ${isUser ? 'float-right' : 'float-left'}`}>
      <div className="flex justify-end">
        <div className={`talk-bubble${isUser ? ' user' : ''} p-2 md:p-4`}>
          {content.processing ? (
            ...
            <Markdown
              remarkPlugins={[remarkGfm, remarkBreaks]} // Add remarkBreaks to render newlines as <br />
              components={{
        ...
        <div className="flex justify-end mt-3">
          <div className="flex items-center gap-2">
            ...
            <Link href={content?.url} target="_blank">
              <div className="chatbot-faq-link flex items-center">
